...
const Bitmap = (width:any, height:any) => {
    const littleEndian = (bitmap:any, index:any, length:any, number:any) => {
        while (length) {
...
function* RandomGenerator(input:any) {
    const generateSeed = (seedInput:any) => {
...
const drawIcon = (data:any, scale:any, input:any) => {
    const repeat = (buffer:any, n:any, start:any, length:any) => {
...
export default class EthIcon extends React.PureComponent<any> {
    objectUrl:any;
    bitmap:any;
    ...
    render() {
        const { address, scale, ...props } = this.props as any;
